...
from title_normalizer import get_normalized_title, IncompleteRequestError, URLRetrievalError

TEST_CASES = [
    # title, url, expected
    ("Screen time causes shallow breathing. Here's how to fix screen apnea : Body Electric : NPR", "", "Screen time causes shallow breathing. Here's how to fix screen apnea : Body Electric"),
    ("Factored Verification: Detecting and Reducing Hallucination in Summaries of Academic Papers", "https://arxiv.org/pdf/2310.10627", "Factored Verification: Detecting and Reducing Hallucination in Summaries of Academic Papers [pdf]"),
